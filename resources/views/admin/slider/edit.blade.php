                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.sliders.index') }}">Sliders</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Edit ({{ $slider->name }})</h3>
                            </div>
                            <form action="{{ route('admin.sliders.update', $slider->slug) }}" method="POST"
