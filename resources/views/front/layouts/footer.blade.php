                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            ...
                                            <p class="contact-txt">{{App\Models\Setting::query()->first()->address}}</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">{{App\Models\Setting::query()->first()->phone}}</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">{{App\Models\Setting::query()->first()->email}}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    ...
                                    <b class="phone-number">{{App\Models\Setting::query()->first()->phone2}}</b>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item social-network">
                                    <ul>
                                        <li><a href="{{App\Models\Setting::query()->first()->twitter}}" target="_blank" class="link-to-item" title="twitter"><i
                                                    class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                        <li><a href="{{App\Models\Setting::query()->first()->facebook}}" target="_blank" class="link-to-item" title="facebook"><i
                                                    class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="{{App\Models\Setting::query()->first()->pinterest}}" target="_blank" class="link-to-item" title="pinterest"><i
                                                    class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                                        <li><a href="{{App\Models\Setting::query()->first()->instagram}}" target="_blank" class="link-to-item" title="instagram"><i
                                                    class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                        <li><a href="{{App\Models\Setting::query()->first()->youtube}}" target="_blank" class="link-to-item" title="youtube"><i
